...
$db['default']['username'] = 'patanja1_emarkit';
$db['default']['password'] = 'emarkit@123*#';
$db['default']['database'] = 'patanja1_emarkit';
...
$db['login']['username'] = 'patanja1_emarkit';
$db['login']['password'] = 'emarkit@123*#';
$db['login']['database'] = 'patanja1_emarkit';
