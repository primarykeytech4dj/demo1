...
<div id="printableArea_<?php echo $customer_bills['id']; ?>" class="printableArea">
	<table border="1" width="100%" style="border: 1px solid black;border-collapse: collapse;">
		...
		<tbody>
			...
			<tr>
				<td colspan="8" align="left"><b>Billing Address:</b> <?php if($customer['address_2']!==NULL){?><?php echo $customer['address_1'],", ".$customer['address_2'].", ".$customer['city'].", ".$customer['area']." - ".$customer['pincode'].", ".$customer['state'].", ".$customer['country']; ?><?php } ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="4"><b>Bank : </b> <?=$company['bank_name']." <br><b>Account Name : </b> ".$company['account_name']." <br>
...
<a href="<?php echo base_url().'billings/load_courier_bill_pdf/'.base64_encode($customer_bills['invoice_no']); ?>" target='_new' />Click Here to download this Bill</a>
