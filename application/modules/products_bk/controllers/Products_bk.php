...
INNER JOIN Shippers ON Orders.ShipperID = Shippers.ShipperID)";*/
	...
	function product_default_attribute($productId){
	    ...
	    if(!empty($defaultAttr)){
	       ...
	       $response = false;
	       //if($priceList){
	           $response = ['product_attribute_id'=>$defaultAttr[0]['id'], 'discount'=>$defaultAttr[0]['discount'], 'default_uom'=>$defaultAttr[0]['uom2'], 'actual_price'=>$defaultAttr[0]['price']-(($defaultAttr[0]['discount']/100.00)*$defaultAttr[0]['price']), 'mrp'=>$defaultAttr[0]['mrp']];
	       //}
