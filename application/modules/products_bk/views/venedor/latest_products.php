                            ...
                            <div class="col-md-9 col-sm-8 col-xs-12 main-content">
                                <!-- <div class="category-toolbar clearfix">
                                    <div class="toolbox-filter clearfix">
                                        ...
                                        <div class="view-box"><a href="category.html" class="active icon-button icon-grid"><i class="fa fa-th-large"></i></a> <a href="category-list.html" class="icon-button icon-list"><i class="fa fa-th-list"></i></a></div>
                                    </div>
                                                ...
                                                <div class="item item-hover cart-product">
                                                    <div class="item-image-wrapper">
                                                        <figure class="item-image-container">
                                                            <?=anchor('product/'.$product['slug'], img(['src'=>content_url().'uploads/products/progress.gif', 'data-src'=>content_url().'uploads/products/thumbs/222xx_'.$product['image_name_1'], 'alt'=>$product['product'], 'class'=>'item-image lazy', 'style'=>'max-height:300px']).img(['src'=>content_url().'uploads/products/progress.gif', 'data-src'=>content_url().'uploads/products/thumbs/222xx_'.$product['image_name_2'], 'alt'=>$product['product'], 'class'=>'item-image-hover', 'style'=>'max-height:300px']))?>
                                                        </figure>
