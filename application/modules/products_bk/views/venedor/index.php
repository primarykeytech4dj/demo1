                                                ...
                                                <div class="item item-hover cart-product">
                                                    <div class="item-image-wrapper">
                                                        <figure class="item-image-container">
                                                            <?=anchor('product/'.$product['slug'], img(['src'=>'', 'data-src'=>content_url().'uploads/products/thumbs/222xx_'.$product['image_name_1'], 'alt'=>$product['product'], 'class'=>'item-image lazy', 'style'=>'max-height:300px']).img(['src'=>'', 'data-src'=>content_url().'uploads/products/thumbs/222xx_'.$product['image_name_2'], 'alt'=>$product['product'], 'class'=>'item-image-hover lazy', 'style'=>'max-height:300px']))?>
                                                        </figure>
