                ...
                <div class="row">
                    <div class="container">
                        <div class="col-2">
                            ...
                            <div class="category-image"><img src="<?=content_url()?>uploads/product_categories/<?=(!empty($parentCategory['image_name_1']))?$parentCategory['image_name_1']:'default.jpg'?>" alt="<?=$parentCategory['category_name']?>" class="img-responsive"></div>
                        </div>
                                                ...
                                                <div class="item item-hover cart-product">
                                                    <div class="item-image-wrapper">
                                                        <figure class="item-image-container">
                                                            <?=anchor('product/'.$product['slug'], img(['src'=>content_url().'uploads/products/progress.gif', 'data-src'=>content_url().'uploads/products/'.$product['image_name_1'], 'alt'=>$product['product'], 'class'=>'lazy item-image', 'style'=>'max-height:300px']).img(['src'=>content_url().'uploads/products/progress.gif', 'data-src'=>content_url().'uploads/products/'.$product['image_name_1'], 'alt'=>$product['product'], 'class'=>'lazy item-image-hover', 'style'=>'max-height:300px']))?>
                                                        </figure>
