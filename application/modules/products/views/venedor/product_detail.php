                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12 product-viewer clearfix">
                                <div id="product-image-carousel-container">
                                    <ul id="product-carousel" class="celastislide-list">
                                        ...
                                        <li class="<?=($key==0)?'active-slide':''?>">
                                            <a data-rel="prettyPhoto[product]" href="<?=content_url()?>uploads/products/<?=$images['image_name_1']?>" data-image="<?=content_url()?>uploads/products/<?=$images['image_name_1']?>" data-zoom-image="<?=content_url()?>uploads/products/<?=$images['image_name_1']?>" class="product-gallery-item">
                                                <img src="<?=content_url()?>uploads/products/<?=$images['image_name_1']?>" alt="<?=$product['product']?>">
                                            </a>
                                        </li>
                                        <li>
                                            <a data-rel="prettyPhoto[product]" href="<?=content_url()?>uploads/products/<?=$images['image_name_1']?>" data-image="<?=content_url()?>uploads/products/<?=$images['image_name_1']?>" data-zoom-image="<?=content_url()?>uploads/products/<?=$images['image_name_1']?>" class="product-gallery-item">
                                ...
                                <div id="product-image-container">
                                    <figure><img src="<?=content_url()?>uploads/products/<?=$product['image_name_1']?>" data-zoom-image="<?=content_url()?>uploads/products/<?=$product['image_name_1']?>" alt="<?=$product['product']?>" id="product-image">
                                        ...
                                        <ul class="related-list clearfix">
                                            <li>
                                                ...
                                                <div class="related-product clearfix">
                                                    <figure><img src="<?=content_url()?>uploads/products/<?=$related['image_name_1']?>" alt="<?=$related['product']?>"></figure>
