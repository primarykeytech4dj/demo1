<div id="breadcrumb-container">
            ...
            <div class="container">
                ...
                if($this->session->flashdata('message')!== FALSE) {
                    ...
                    <div class="row">
                        <div class="col-md-12 <?php echo $msg['class'];?>">
                                ...
                                <table class="table cart-table">
                                    ...
                                    foreach ($this->cart->contents() as $key => $item) {
                                        ...
                                        <tr>
                                            <td class="item-name-col cart">
                                                ...
                                                <ul class="pull-right">
                                                    ...
                                                    <li>Select <?=$variationKey?>:
                                                        <input type="hidden" name="options[<?=$counter?>][<?=$variationKey?>]" value="<?=$variation[0]?>" id="<?=$item['rowid'].$variationKey?>">
                                            ...
                                            <td><?=$stock[$item['id']]?> Pcs</td>
                                            <td>
                                                <div class="custom-quantity-input">
                                                    <input type="number" name="qty[<?=$counter?>]" value="<?=$item['qty']?>" min="0" max="<?=$stock[$item['id']]?>"> <!-- <a href="#" class="quantity-btn quantity-input-up"><i class="fa fa-angle-up"></i></a> <a href="#" onclick="return!1" class="quantity-btn quantity-input-down"><i class="fa fa-angle-down"></i></a> --></div>
                                            </td>
                                            <td class="item-total-col"><span class="item-price-special"><?=$item['price']*$item['qty']?></span>
                                                <!-- <a href="#" class="close-button remove-cart-item" data-id='<?=$item['rowid']?>'></a> -->
                                            </td>
                                        </tr>
                                            <?php
                                            $counter++;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                ...
                                <div class="md-margin"></div>
                                    ...
                                    <?=anchor('checkout', 'CHECKOUT', ['class'=>'btn btn-custom'])?>
