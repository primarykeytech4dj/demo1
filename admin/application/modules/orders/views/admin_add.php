			...
			<div class="nav-tabs-custom">
				<div class="tab-content">
					<div class="tab-pane active" id="basic_detail"> 
						<?php echo form_open_multipart(custom_constants::new_order_url, ['class'=>'form-horizontal submit-ajax', 'id'=>'register_order', 'onsubmit'=>"myButtonValue.disabled = true; return true;"]); 
