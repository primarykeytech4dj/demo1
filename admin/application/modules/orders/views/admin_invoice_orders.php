        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <?php echo form_open_multipart('', ['class'=>'form-vertical', 'id'=>'invoice_filter']); ?>
                <div class="row">
                  <div class="col-md-3">
                  <label>Zone no</label>
                    <?php 
                    echo form_dropdown('filters[zone][]', $option['zone'],'',"id='zone' class='form-control select2 zone' multiple='multiple'"); 
                  ...
                  echo form_dropdown('filters[routes][]', ['select Attributes'],'',["id"=>'routes', 'class'=>'form-control select2', 'multiple'=>'multiple']); 
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="inputSalesPerson">Sales Person</label>
                          ...
                          <select name="filters[sale_by]" class="form-control select2" id="sale_by">
			...
			<table class="table" id="target">
				...
				foreach ($invoiceorders as $invoiceKey => $invoice) { 
					...
					<tr id="<?=$counter?>">
						...
						<td rowspan="<?=count($invoice['orders'])?>"><?=$invoice['default_address_count']?></td>
