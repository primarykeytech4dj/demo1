			...
			<div class="nav-tabs-custom">
				<div class="tab-content" style="padding: 0">
					<div class="tab-pane active" id="basic_detail"> 
						<?php echo form_open_multipart(custom_constants::new_order_url2, ['class'=>'form-horizontal submit-ajax', 'id'=>'register_order']); 
							...
							<div class="box box-info">
								...
								<div class="box-body" style="padding: 5px;">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													echo form_dropdown('data[orders][customer_id]', $option['customer'], isset($customer_id)?$customer_id:set_value('data[orders][customer_id]'), $input['customer_id']);
													 ?>
														...
														<div class="col-md-12">
											                <div class="form-group">
        													    ...
        													    <div class="col-xs-10">
																	...
																	<input type="hidden" value="<?=$min_order?>" name="min_order" id="min_order">
        													        <?php echo form_dropdown("order_details[0][product_id]",$option['product'],'',["id" =>'product_id_0', 'required'=>'required', 'class'=>'form-control product_id select2 required', "style" => 'width:100% !important']);?>
        													    </div>
        													</div>
        												</div>
													</div>
													...
													<!-- <div class="row">
													    <div class="col-md-12">
											                <div class="form-group">
        													    ...
        													    <div class="col-xs-10"> -->
        													        <input type="hidden" name="order_details[0][tax]" class="form-control calculate nochange" id="tax_0" value="0.00" readonly>
        													    <!-- </div>
        													</div>
        												</div>
													</div> -->
									...
									<div class="row">
										<div class="col-md-12 col-xs-12 pull-right">
											<div class="form-group">
												<label for="inputAmount_after_tax" class="col-sm-4 control-label">Amount After Tax</label>
												<div class="col-sm-8">
