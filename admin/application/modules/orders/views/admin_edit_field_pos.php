...
{ //echo '<pre>';print_r($values_posted);exit;
			...
			<div class="nav-tabs-custom">
				<div class="tab-content" style="padding: 0">
					<div class="tab-pane active" id="basic_detail"> 
						<?php echo form_open_multipart('orders/editorderfieldpos/'.$id, ['class'=>'form-horizontal', 'id'=>'register_order']); 
							...
							<div class="box box-info">
								...
								<div class="box-body" style="padding: 5px;">
									...
									<div class="row">
										<?php echo form_hidden(['data[orders][id]'=>$id]);?>
										<div class="col-md-4">
											<div class="form-group">
												<label for="inputVendor_id" class="col-sm-2 control-label">Customer</label>
												<div class="col-sm-10">
													<?php //echo form_input($input['vendor_id']);
													echo form_dropdown('data[orders][customer_id]', $option['customer'], $values_posted['orders']['customer_id'], $input['customer_id']);
													 ?>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<?php 
													echo form_dropdown('data[orders][shipping_address_id]', $option['address'], $values_posted['orders']['shipping_address_id'], $input['delivery_address_id']);
													 ?>
						...
						<!-- /box-body -->
							 		<div class="box-header with-border">
										<h2 class="box-title text-center">Order Details</h2>
									</div>
									<div class="box-body" style="overflow-x:scroll">
										<table class="table details">
											<tbody>
											<?php if(count($values_posted['orderDetails'])>0){
												foreach ($orderDetails as $key => $value) {?>
													<tr id="<?=$key?>">
														<td>
															<input type="hidden" name="order_details[<?=$key?>][id]" id="order_detail_id_<?=$key?>" value="<?=$value['id']?>">
															<div class="row">
															    <div class="col-md-12">
													                <div class="form-group">
		        													    <div class="col-xs-2">
		        													    ...
		        													    <div class="col-xs-10">
		        													    	<?php echo form_dropdown("order_details[".$key."][product_id]",$option['product'],$value['product_id'],["id" =>'product_id_'.$key, 'required'=>'required', 'class'=>'form-control select2 filter required product_id', 'data-link' => 'products/productwise_attributes', "data-target" => 'productattributeid_'.$key, "style" => 'width:100% !important']);?>
		        													    </div>
		        													</div>
		        												</div>
															</div>
															<div class="row">
															    <div class="col-md-12">
													                <div class="form-group">
		        													    ...
		        													    <div class="col-xs-10">
		        													        <?php echo form_dropdown("order_details[".$key."][product_attribute_id]", $value['attributeList'],$value['product_attribute_id'],["id" =>'productattributeid_'.$key, 'required'=>'required', 'class'=>'form-control select2 attribute', "style" => 'width:100% !important']); ?>
		        													    </div>
		        													</div>
		        												</div>
															</div>
															<div class="row">
															    <div class="col-md-12">
													                <div class="form-group">
		        													    ...
		        													    <div class="col-xs-10">
		        													        <input type="text" name="order_details[<?=$key?>][unit_price]" class="form-control calculate" id="unit_price_<?=$key?>" value="<?=$value['unit_price']?>" readonly>
		        													    </div>
		        													</div>
		        												</div>
															</div>
															<div class="row">
															    <div class="col-md-12">
													                <div class="form-group">
		        													    ...
		        													    <div class="col-xs-10">
		        													        <input type="number" name="order_details[<?=$key?>][qty]" class="form-control required calculate" id="qty_<?=$key?>" value="<?=$value['qty']?>" min="1" required="required" style="min-width: 60px">
															...
															<div class="row">
															    <div class="col-md-12">
													                <div class="form-group">
		        													    ...
		        													    <div class="col-xs-10">
		        													    	<input type="checkbox" name="order_details[<?=$key?>][is_active]" id="is_active_<?=$key?>" <?php if($value['is_active']){echo  "value=1 checked='checked'"; }else{ echo  "value=0"; }?> >
		        													    </div>
		        													</div>
		        												</div>
															</div>
														    ...
														    <div class="col-md-12">
												                <div class="form-group">
	        													    ...
	        													    <div class="col-xs-10">
	                													...
	                													<input type="hidden" name="order_details[0][tax]" class="form-control calculate nochange" id="tax_0" value="0.00">
														...
														<div class="row">
														    <div class="col-md-12">
												                <div class="form-group">
	        													    ...
	        													    <div class="col-xs-10">
	        													        <input type="checkbox" name="order_details[<?=$key?>][is_active]" class="" id="is_active_<?=$key?>" <?php if($value['is_active'] == true){echo 'checked';}
	        													        	?> >
	        													    </div>
	        													</div>
	        												</div>
