...
class Employees extends MY_Controller {
    ...
    public function rolewise_employees($roleId=''){
        $sql = 'select concat(e.first_name," ", e.middle_name," ",e.surname) as name, e.emp_code, e.id, ur.login_id from employees e inner join user_roles ur on ur.user_id=e.id AND ur.account_type="employees" inner join login l on l.id=ur.login_id';
        if($roleId!=''){
        ...
        $employees = $this->pktdblib->custom_query($sql);
        return $employees;
    }
