        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:scroll">
              ...
              <?php } ?>
              <?php echo form_open('orders/exportDeliveryReport', ['class'=>'form-vertical', 'id' => 'export_delivery_report']); ?>
              <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <?php echo form_dropdown('delivery_no[]', $option['deliveryNo'], '0', ['class'=>'form-control select2', 'multiple'=>'multiple', 'id'=>'delivery_no']); ?>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" class="SingleCheck" name="exportReport" value="Export-Stock Summary" checked id="summaryrep">Stock Summary<br>
                        <input type="checkbox" class="SingleCheck" name="exportReport" value="Export-Day Book" id="daybookrep">Day Book
  ...
  function format ( d ) {
    ...
    table = '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'+
        ...
        if(d.order_status_id==9){
          table+='<tr>'+
              '<th colspan="2"> <a class="btn btn-md btn-danger" href="'+base_url+'fieldmember_panel/view_OrderDetail2/'+btoa(d.company_id+"-"+d.bill_type+"-"+d.id)+'"><i class="fa fa-truck alert-danger"></i> Update</a></th>'+
          '</tr>';
  ...
  $(document).ready(function(){
    var table = $('#ajaxLoader').DataTable({
      ...
      'columns': [
        ...
        { data: 'area_name' },
        /*{ data: 'total_qty' },*/
        { data: 'amount_after_tax', 'className': "pull-right" },
        { data: 'created' },
         //{ data: 'message' },
        //{ data: 'action' },
