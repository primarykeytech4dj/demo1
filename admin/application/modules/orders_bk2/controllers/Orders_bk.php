...
class Orders extends MY_Controller {
    ...
    public function admin_invoice_order_form($data = []){
        $date = '2021-12-07';//date('Y-m-d', strtotime('-50 day'));
                            ...
                            if(count($orderedProducts)>0){
                                foreach($orderedProducts as $odKey=>$detail){
                                    ...
                                    if(count($gstRates)>0){
                                        ...
                                        $gcalc = round($bill['rate']*$bill['qty']*$gstRates[0]['gst_rate']/(100+$gstRates[0]['gst_rate']), 2);
                                    ...
                                    $wgstValue = round($bill['rate']*$bill['qty']*100/(100+$gstRates[0]['gst_rate']),2);
