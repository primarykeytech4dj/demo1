	...
	private function _validate_login($username, $password, $type) {
		...
		{	
			...
			if(password_verify($password, $hashed_pass) === TRUE)
			{
				...
				$session_data['password'] = $hashed_pass;
...
*/ 
	...
	function admin_index_2() {
		...
		if($this->input->is_ajax_request()){  
			...
			$data = $this->mdl_login->login_listing('modified desc, is_active desc',$postData);
            foreach($data['aaData'] as $key=>$v){
                ...
                <div class="input-group-btn">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                        '.anchor('login/admin_edit_user/'.$v['id'], '<i class="fa fa-edit"></i> Edit').'
                        </li>';
	...
	function admin_login_listing($data = []) {
		...
		$data['option']['roles'] = [''=>'Select Roles','2'=>'Admin','3'=>'Customers',
									'4'=>'Accountant','5'=>'Vendor','6'=>'Delivery Boy',
									'7'=>'Sales','8'=>'Store Keeper','9'=>'Sales Manager'];
