        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <?php 
              if(!isset($module)){ 
                echo anchor(custom_constants::new_address_url, 'New Address', ['title'=>'New Address', 'class'=>'btn btn-primary pull-right']);
              } ?>
            </div>
            <!-- /.box-header -->
                   ...
                   <div class="input-group-btn">
                      ...
                      ?>
                       <li>
                        ...
                        echo anchor($url2, 'Edit', ['class'=>'']);  ?></li> 
                        <li><?//=anchor('address/delete_address/'.$v['id'], 'Delete', []);?>
                          <button type="button" class="btn btn-default delete-address" data-id="<?=$v['id']?>" id="delete-address" data-path="address/delete_address" data-table="address">Delete</button></li>
                      </ul>
                    </div>
                  </td>  
