  ...
  <div class="col-sm-12">
    ...
    <div class="box">
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="form-group ">
              ...
              <?php 
              $introducerId = 0;
              //print_r($values_posted['customer_references']);
              ...
              <input type="text" name="data[proposer_id]" class="form-control" id="proposer_id" style="display:block" placeholder="Proposer Not found? Enter Proposer ID Here">
            ...
            <div class="form-group row"> -->
              ...
              <div class="col-sm-4">
                <input class="form-control" type="text" placeholder="Proposer name will be displayed here" id="proposer_name" disabled="disabled">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                if(set_value('data[customers][gender]'))
                 ...
                 ?>
                 <!-- <select name="data[customers][gender]" id="gender" class="form-control">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <?php 
                $placement = '';
                if(set_value('data[customers][placement]'))
                  $placement = $values_posted['customers']['placement'];
                 ?>
               <label class="radio-inline"><input type="radio" name="data[person_under][placement]" value="left" <?php echo  set_radio('data[person_under][placement]', 'left', TRUE); ?>>Left</label>
               <label class="radio-inline"><input type="radio" name="data[person_under][placement]" value="right" <?php echo  set_radio('data[person_under][placement]', 'right', TRUE); ?>>Right</label>
               <!--  <select name="data[customers][placement]" id="placement" class="form-control">
                 <option value="" <?php if($placement==''){ echo 'selected="selected"';} ?>>Select Position</option>
                 <option value="left" <?php if($placement=='left'){ echo 'selected="selected"';} ?>>Left</option>
                 <option value="right" <?php if($placement=='right'){ echo 'selected="selected"';} ?>>Right</option>
               </select> -->
              </div>
            </div>
            <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <label class="checkbox-inline"><input type="checkbox" value="1" required="required">I agree term of services, Please Register.<a href='#' style='color:black;text-decoration: none;'>Terms & Condition</a></label>
          </div>
        </div>
