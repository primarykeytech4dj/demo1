...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      echo form_open_multipart(custom_constants::new_customer_url_new, ['class'=>$formClass, 'id' => 'register_customer']);
...
<script>
    $("#contact_1").on('blur', function(){
       $('#primary_email').val($(this).val()+'@expedeglobal.com'); 
    });
</script>