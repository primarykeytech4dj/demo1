...
/*echo '<pre>';
print_r($this->session->userdata('application'));
print_r($setup);
echo '</pre>';*/
...
/*echo '<pre>';
print_r($_SESSION['application']);exit;*/
if((isset($_SESSION['application']['tally']) && $_SESSION['application']['tally']==1) || (isset($_SESSION['application']['export_for_tally']) && $_SESSION['application']['export_for_tally']==1)){ 
	//echo "hii";
...
$input['hsn_sac_code'] = array(
						"name" => "data[product_gst_rates][hsn_sac_code]",
...
$input['gst_rate'] = array(
						"name" => "data[product_gst_rates][gst_rate]",
						"placeholder" => "GST Rate %",
						//"required" => "required",
						"class"=> "form-control",
						"id" => "gst_rate"
					);
$input['effective_from'] = array(
						"name" => "data[product_gst_rates][effective_from]",
...
if($_SESSION['application']['product_has_multiple_categories']){
	$input['product_categories']['multiple'] = 'multiple';
}
$type 	=	array(
				'id'	=>	'type_0',
				//'required'	=>	'required',
						...
						echo form_open_multipart(custom_constants::new_product_url, ['class'=>'form-horizontal', 'id'=>'new_product']);
							...
							<div class="box box-info">
								...
								<div class="box-body">
									...
									<div class="row">
									<?php if(isset($_SESSION['application']['multiple_company']) && $_SESSION['application']['multiple_company']==true && !$setup['share_products']){?>
										<div class="col-md-4">
									...
									<div class="col-md-4">
										<div class="form-group">
        									...
        									echo '</pre>';*/
        									if($_SESSION['application']['product_has_multiple_categories']){
        									    echo form_dropdown('data[product_product_categories][product_category_id][]', $option['category'], isset($values_posted)?$values_posted['product_product_categories']['product_category_id']:'',"id='category' required='required' class='form-control select2' multiple='multiple' style='width:100%'");
        										echo form_error('data[product_product_categories][product_category_id][]');
        									}else{
            									echo form_dropdown('data[products][product_category_id]', $option['category'], isset($values_posted)?$values_posted['products']['product_category_id']:'',"id='category' required='required' class='form-control select2' multiple='multiple'"); 
            									echo form_error('data[products][product_category_id]'); 
        									}
        									?>
									            </div>
											</div>
									...
									<div class="col-md-4">
										...
										<?php if((isset($_SESSION['application']['tally']) && $_SESSION['application']['tally']==1) || (isset($_SESSION['application']['export_for_tally']) && $_SESSION['application']['export_for_tally']==1)){ ?>
										<div class="col-md-4">
											<div class="form-group">
								...
								<!-- <div class="box-footer">  --> 
                                    ...
                                    <div class="box-haeder with-border">
										<h2 class="box-title">Item GST Rate</h2>
									</div>
									<div class="box-body" style="overflow-x:scroll">
										<div class="row">
										    <div class="col-md-4">
    											<div class="form-group">
    												<label for="inputHsn_sac_code" class="col-sm-6 control-label">HSN/SAC Code</label>
    												<div class="col-sm-6">
    													<?php echo form_input($input['hsn_sac_code']);?>
    													<?php echo form_error('data[product_gst_rates][hsn_sac_code]');?>
    												</div>
    											</div>
    										</div>
    										<div class="col-md-4">
    											<div class="form-group">
    												<label for="inputGst_rate" class="col-sm-6 control-label">GST Rate</label>
    												<div class="col-sm-6">
    													<?php echo form_input($input['gst_rate']);?>
    													<?php echo form_error('data[product_gst_rates][gst_rate]');?>
    												</div>
    											</div>
    										</div>
    										<div class="col-md-4">
    											<div class="form-group">
    												<label for="inputEffective_from" class="col-sm-6 control-label">Effective From</label>
    												<div class="col-sm-6">
    													<?php echo form_input($input['effective_from']);?>
    													<?php echo form_error('data[product_gst_rates][effective_from]');?>
    												</div>
    											</div>
    										</div>
										</div>
