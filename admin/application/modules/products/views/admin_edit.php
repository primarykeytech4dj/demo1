		...
		<div class="col-md-12">
        	...
        	<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					...
					<?php } ?>
					<li class="<?php if($tab=="gst_rate"){echo "active";} ?>"><a href="#gst_rate" data-toggle="tab">Gst Setup</a></li>
					<?php if($values_posted['products']['is_active']){?>
					<li class="<?php if($tab=="rate_calculator"){echo "active";} ?>"><a href="#rate_calculator" data-toggle="tab">Rate Calculator</a></li>
					<?php } ?>
				...
				<div class="tab-content">
					<div class="tab-pane <?php if($tab=="product_details"){echo "active";} ?>" id="product_details"> 
						...
						?>
							<div class="box box-info">
								...
								<div class="box-body">
									<div class="row">
									<?php if($_SESSION['application']['multiple_company'] && !$setup['share_products']){
										?>
										<div class="col-md-4">
									...
									<?php } ?>
										...
										<div class="col-md-4">
        									...
        									if($_SESSION['application']['product_has_multiple_categories']){
        									    echo form_dropdown('data[product_product_categories][product_category_id][]', $option['category'], isset($product_category_id)?$product_category_id:'',"id='category' required='required' class='form-control select2' multiple='multiple' style='width:100%'");
        										echo form_error('data[product_product_categories][product_category_id][]');
        									}else{
            									echo form_dropdown('data[products][product_category_id]', $option['category'], isset($values_posted)?$values_posted['products']['product_category_id']:'',"id='category' required='required' class='form-control select2' style='width:100%'");
					...
					<div class="tab-pane <?php if($tab=="gst_rate"){echo "active";} ?>" id="gst_rate">
						<?php echo $gstRates; ?>
					</div>
					...
					<div class="tab-pane <?php if($tab=="rate_calculator"){echo "active";} ?>" id="rate_calculator">
						<?php echo $rateCalculator; ?>
					</div>
				</div><!-- /tab-content-->
			</div><!-- /nav-tabs-custom -->
        </div>
