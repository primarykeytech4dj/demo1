			...
			<div class="nav-tabs-custom">
				<div class="tab-content">
					<div class="tab-pane active" id="basic_detail"> 
						<?php echo form_open_multipart(isset($test)?"orders/exportxml2":"orders/exportxml", ['class'=>'form-vertical', 'id'=>'export_order', 'onsubmit'=>"myButtonValue.disabled = true; return true;"]); 
