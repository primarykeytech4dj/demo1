    ...
    <div class="col-md-12">
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            ...
            echo form_open_multipart(custom_constants::new_role_url, ['class'=>'form-horizontal', 'id'=>'new_role']);
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-shopping-bag margin-r-5"></i> New Role</h3>
                </div><!-- /box-header -->
                <!-- form start -->
                <div class="box-body">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="inputRole" class="col-sm-2 control-label">Modules</label>
                        <div class="col-sm-10">
                          <?php echo form_dropdown("data[roles][module]", $option['module'],'',"id='module' required='required' class='form-control select2'"); ?>
                ...
                <div class="box-footer">  
                  <button type="new_college" class="btn btn-info pull-left">Add Role</button> &nbsp;&nbsp;&nbsp;&nbsp;
