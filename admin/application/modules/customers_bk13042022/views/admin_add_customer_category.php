...
$input['parent_id'] = array(
						"name" => "data[customer_categories][parent_id]",
						"required" => "required",
...
$input['category_name'] = array(
						"name" => "data[customer_categories][category_name]",
...
$input['description'] =  array(
							...
							//"type"	=> "file",
							"id" => "description",
							"value" =>	set_value('customer_categories'),
						);

$input['slug'] =  array(
							"name" => "data[customer_categories][slug]",
							"placeholder" => "slug *",
							"max_length" => "255",
							"required" => "required",
...
$input['meta_title'] =  array(
							"name" => "data[customer_categories][meta_title]",
...
$input['meta_keyword'] =  array(
							"name" => "data[customer_categories][meta_keyword]",
...
$input['meta_description'] =  array(
							"name" => "data[customer_categories][meta_description]",
...
$input['description'] = array(
						"name" => "data[customer_categories][description]",
...
$input['is_active'] =  array(
							"name" => "data[customer_categories][is_active]",
							"type" => "checkbox",
							"class" => "flat-red",
							"id" => "is_active",
							"value" => true
...
<section class="content-header">
	...
	<ol class="breadcrumb">
	    ...
	    <li>
	      <?php echo anchor(custom_constants::admin_customer_category_listing_url, 'Customer Category', 'title="Customer Category" id="customer_categories"'); ?>
	    </li>
		...
		<div class="col-md-12">
			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
						...
						echo form_open_multipart(custom_constants::new_customer_category_url, ['class'=>'form-horizontal', 'id'=>'customer_categories']);
							...
							<div class="box box-info">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<?php echo form_dropdown('data[customer_categories][parent_id]', $option['parent'], isset($values_posted)?$values_posted['data']['customer_categories']['parent_id']:'', $input['parent_id']); ?>
													<?php echo form_error('data[customer_categories][parent_id]'); ?>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[customer_categories][category_name]'); ?>
												</div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[customer_categories][slug]'); ?>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
							                      <?php echo form_input($input['meta_title']); ?>
							                          <?php echo form_error('data[customer_categories][meta_title]'); ?>
							                  </div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[customer_categories][meta_keyword]');?>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[customer_categories][meta_description]');?>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="box-footer">  
									<button type="submit" class="btn btn-info pull-left">Add Customer Category</button> &nbsp;&nbsp;&nbsp;&nbsp;
