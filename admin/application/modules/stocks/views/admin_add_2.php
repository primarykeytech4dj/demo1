...
$input['remark'] = array(
						"name" => "data[stocks][remark]",
						"placeholder" => "Remark",
						"class"=> "form-control",
						"id" => "remark",
					);
					
$input['running_mtr'] = array(
						"name" => "data[stocks][running_mtr]",
						"placeholder" => "Running_mtr",
						"class"=> "form-control",
						"id" => "running_mtr",
					);
											...
											<table class="table">
												...
												<tbody>
													<tr id="0">
														...
														<td>
															<input type="text" name="stock_details[0][lorry_no]" class="form-control required" id="lorry_no_0" required="required">
														</td><td>
															<input type="text" name="stock_details[0][invoice_no]" class="form-control required" id="invoice_no_0" required="required">
														</td>
														<!--<td>
														...
														<td>
															<input type="text" name="stock_details[0][running_mtr]" class="form-control required" id="running_mtr_0" value="" required="required">
														</td>
														<td>
														...
														<td>
															...
															<td>
															<input type="text" name="stock_details[0][reck]" class="form-control" id="reck_0" value="" required="required">
															</td>
															
															<td>
															<input type="text" name="stock_details[0][remark]" class="form-control" id="remark_0" value="" required="required">
															</td>
