...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <!-- Horizontal Form -->
      <?php echo form_open_multipart('billings/clientWiseBill', ['class'=>'form-horizontal', 'id' => 'register_customer']);
      if(isset($form_error)) 
      {
          ...
          <div class="box-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="inputcustomer_id" class="col-sm-2 control-label">Select Customer For Billing</label>
                    <div class="col-sm-10">
                      
                      <?php echo form_dropdown('data[customer_site_bills][customer_id][]',$option['billingClients'], isset($value_posted['data']['customer_site_bills']['customer_id'])?$value_posted['data']['customer_site_bills']['customer_id']:'',$billingClients);?>
                      <?php echo form_error('data[customer_site_bills][customer_id][]'); ?>
                    </div>
                </div>
              </div>
