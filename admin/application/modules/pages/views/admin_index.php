            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-striped example2">
                ...
                <tr>
                  ...
                  <td><img src="<?php echo content_url(); ?>uploads/featured_images/<?php echo $page['featured_image'] ;?>" alt="<?php echo $page['featured_image'];?>" height="80px" width="80px"></td>
                  ...
                  <td>
                    <div class="input-group-btn">
                      ...
                      <ul class="dropdown-menu">
                        <li><?php echo anchor(custom_constants::admin_page_view."/".$page['id'], 'View', ['class'=>'']);  ?></li>
