...
$input['featured_image2'] = array(
								'data[pages][featured_image2]' =>!set_value('featured_image')?$value_posted['pages']['featured_image']:set_value('featured_image'),
								'data[pages][id]' => $id,
							);	
/*echo '<pre>';
print_r($value_posted);
				              ...
				              <div class="col-md-12">
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-10">
				                      ...
				                      <img src="<?php echo !empty($value_posted['pages']['featured_image'])?content_url().'uploads/featured_images/'. $value_posted['pages']['featured_image']:base_url().'assets/uploads/profile_images/defaultm.jpg'; ?>" height="100px" width="100px">
				                  </div>
				                </div>
				              </div>     
				            </div><!-- /row -->
