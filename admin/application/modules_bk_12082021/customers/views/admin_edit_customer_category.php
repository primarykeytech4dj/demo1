...
$value='';
// /echo $values_posted['customer_categories']['dob'];exit;
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li>
			<?php echo anchor(custom_constants::admin_customer_category_listing_url, 'customer Categories', 'title="customer_categories" id="customer_categories"'); ?>
		</li>
		...
		<div class="col-md-12">
        	...
        	<div class="nav-tabs-custom">
				...
				<div class="tab-content">
					...
					<?php  
					echo form_open_multipart(custom_constants::edit_customer_category_url."/".$id, ['class'=>'form-horizontal', 'id'=>'customer_categories'])
					?>
								...
								<div class ="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<?php 
												echo form_dropdown('data[customer_categories][parent_id]', $option['parent'], $values_posted['customer_categories']['parent_id'], 'class="form-control select2" id="parent_id" style="width:100%"');
												?>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-sm-10">
												...
												<?php echo form_error('data[customer_categories][is_active]');?>
											</div>
										</div>
									</div>
								</div><!-- /row -->
