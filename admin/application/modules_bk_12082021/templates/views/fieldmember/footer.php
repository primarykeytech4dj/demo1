...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo (date('m')>3)?date('Y').' - '.date('Y',strtotime('+1 Year')):date('Y',strtotime('-1 Year')).' - '.date('Y'); ?> <a href="http://primarykey.in" target="_new"><?php echo $meta_keyword;?></a>.</strong> All rights
    reserved.
  </footer>
  <!-- Modal -->
