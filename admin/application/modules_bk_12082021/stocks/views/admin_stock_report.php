...
<?php echo form_open_multipart('stocks/admin_stock_report', ['class'=>'form-horizontal stock_report_filter', 'id' => 'stock_report_filter']);
        ...
        <div class="box box-info">
			...
			<?php echo form_close(); ?>
            <hr>
            <?php echo form_open_multipart('stocks/admin_stock_report', ['class'=>'form-horizontal stock_report', 'id' => 'stock_report']); ?>
            <div class="box-body">
	            <div class="row">
					<div class="col-md-12" id="dvData">
						<table id="report" class="table table-bordered table-striped report" style="table-layout:fixed">
				            ...
				            <tr>
				              ...
				              <td><?php if($netBalance>0){ ?><input type="checkbox" name="stock_details[<?=$key?>]" id="create_so_<?=$key?>" class="" value="<?=$v['id']?>"><?php } ?> <?=$v['coil_no']?></td>
				            ...
				            <tfoot>
				                <tr><th colspan="10" class="text-center">Total Qty</th><td id="netquantity"></td>
	        ...
	        <button type="submit" class="float create_so">
