...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li>
      <?php echo anchor('#', 'vendor Categories', 'title="vendor_categories"'); ?>
    </li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <?php if(!isset($module)){ ?>
                <?php echo anchor(custom_constants::new_vendor_category_url, 'New Category', 'class="btn btn-primary pull-right"'); ?>
                 <!--  <a href="<?php echo custom_constants::new_vendor_category_url; ?>" title="" class="btn btn-primary pull-right">New Category</a> -->
              <?php } ?>
            </div>
            <!-- /.box-header -->
                  ...
                  <td>
                   <div class="input-group-btn"><?php echo $category['id']; ?>
                      ...
                      <ul class="dropdown-menu">
                       <li>
                        <?php 
                        $url = custom_constants::edit_vendor_category_url;
