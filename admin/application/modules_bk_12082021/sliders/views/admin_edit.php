                      ...
                      <tbody>
                        <?php if(count($values_posted['slider_details'])>0){
                         ...
                         //print_r($slider_detail['title_1']);
                            ...
                            <tr id="<?php echo $key;?>">
                                <td>
                                <?php echo form_dropdown('slider_details['.$key.'][filter_text]', ['default'=>'Default', 'old app'=>'Old app'], isset($slider_detail['filter_text'])?$slider_detail['filter_text']:'default', $filterText);?></td>
                        ...
                        <tr id="0">
                            <td>
                                <?php echo form_dropdown('slider_details[0][filter_text]', ['default'=>'Default', 'old app'=>'Old app'], 'default', $filterText);?></td>
