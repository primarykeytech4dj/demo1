      ...
      <div class="mb-1">
        <div class="pt-4">
          <ul class="list-group list-group-flush">
            ...
            <li class="pt-3 d-flex justify-content-between align-items-center border-0 px-0 pb-0 text-gray">
              Invoice Total
              <span class="font-italic" id="amount_after_tax"><?=$order['amount_after_tax']?></span>
            </li>
            ...
            <div class="col-lg-12">
    	        <div class="form-group">
					...
					<div class="mb-9">
						...
						echo form_dropdown('data[orders][order_status_id]', ['1'=>'Pending', '5'=>'Delivered', '2'=>'Cancelled'], /*$order['order']['order_status_id']*/'', ["id"=>'order_status_id', 'required'=>'required', 'class'=>'form-control', 'tab-index'=>1, 'style'=>'width:100%']);?>
