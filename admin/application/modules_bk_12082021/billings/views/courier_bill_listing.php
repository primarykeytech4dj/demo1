  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <!-- /.box-header -->
        <?php echo form_open('billings/print_multiple_courier_bills'); ?>
        <div class="box-body" style="overflow-x: scroll;">
          ...
          <table id="example2" class="table table-bordered table-striped example2">
            ...
            <tr>
              ...
              <td><?php echo $bill['fuel_surcharge'] ;?></td>
              <td><?php echo $bill['service_charge'] ;?></td>

              <!-- <td><?php echo $bill['area_name'] ;?></td> -->
              <td><?php echo $bill['amount_before_tax'];?></td>
              <td><?php echo $bill['amount_after_tax'];?></td>
              <td><?php if($bill['payment_id'] == NULL){
                ?>
              <input type="checkbox" name="data[bills][<?=$key?>]" value="<?php echo $bill['id']; ?>" class="payment_received" data-id="<?php echo $bill['id']; ?>" >
              ...
              <td>
               <div class="input-group-btn">
                 ...
                 <ul class="dropdown-menu">
                   ...
                   <li><?php echo anchor('billings/load_courier_bill_pdf/'.base64_encode($bill['invoice_no']), 'Print Bill', ['class'=>'', 'target'=>'_blank']);  ?></li> 
                  </ul>
                </div>
              </td>  
             <!--  <td>
