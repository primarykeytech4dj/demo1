...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyB_ta0Gnqvxtov47Mqnx4amJxeLviv2HAk'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function initialize($config = array())
	{
		...
		if ($this->sensor) { $this->sensor = ""; }else{ $this->sensor = ""; }
