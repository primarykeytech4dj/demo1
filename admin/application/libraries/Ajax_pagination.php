...
class Ajax_pagination{
    ...
    var $first_link      = '';
    var $next_link       = '<span aria-hidden="true">&#187;</span><span class="sr-only">Next</span>';
    var $prev_link       = '&#171;';
    var $last_link       = '';
    var $uri_segment     = 4;
    var $full_tag_open   = '<nav aotherInstituteDataria-label="Page navigation example"><ul class="pagination">';
    var $full_tag_close  = '</ul></nav>';
    var $first_tag_open  = '&nbsp;';
    var $first_tag_close = '';
    var $last_tag_open   = '&nbsp;';
    var $last_tag_close  = '';
    var $cur_tag_open    = '<li class="page-item active"><a href="#" class="page-link"><b>';
    var $cur_tag_close   = '</b></a></li>';
    var $next_tag_open   = '<li class="page-item bg999">';
    var $next_tag_close  = '</li>';
    var $prev_tag_open   = '<li class="page-item bg999">';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<p>Showing : ' . $this->total_rows.'</p>';
            return $info;
        }
        ...
        $output = $recordDisplay.$this->full_tag_open.$output.$this->full_tag_close;
        ?>
        <script>
        function getData(page){  
            $.ajax({
                ...
                success: function(data){
                    //console.log('<?php echo $this->target; ?>');
