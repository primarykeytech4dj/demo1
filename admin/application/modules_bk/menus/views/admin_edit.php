...
$input['module'] = array(
						"name" => "data[dyn_menu][module_name]",
						"placeholder" => "module",
						"max_length" => "64",
						//"required" => "required",
						"class"=> "form-control",
...
$input['icon'] = array(
						...
						"class"=> "form-control",
						"id" => "icon",
						"value" => ($values_posted['dyn_menu']['icon_type']=='Image')?'':$values_posted['dyn_menu']['icon'],
					);

$input['icon_image_1'] = array(
						"data[dyn_menu][icon_image_1]"=>$values_posted['dyn_menu']['icon'],
						"data[dyn_menu][id]"=>$values_posted['dyn_menu']['id'],
...
/*$input['icon2'] =  array(
							"data[dyn_menu][icon2]" => $values_posted['dyn_menu']['icon'],
							"data[dyn][id]" => $id
...
$iconImage = $values_posted['dyn_menu']['icon'];
//echo $iconImage;
if($values_posted['dyn_menu']['icon_type']=='Image')
	unset($values_posted['dyn_menu']['icon']);

/*echo '<pre>';
print_r($values_posted['dyn_menu']);
echo '</pre>';*/
...
{ //print_r($values_posted);
	foreach($values_posted as $post_name => $post_value)
	{
		foreach ($post_value as $field_key => $field_value) {
			//echo $field_key."<br>";
			if(isset($input[$field_key]['type']) && $input[$field_key]['type']=="checkbox" && $field_value==1){
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_dropdown('data[dyn_menu][dyn_group_id]',$option['dyn_group'], $dyn_menu['dyn_group_id'],"id='dyn_group_id' required='required' class='form-control select2 filter'   tab-index=1 style='width:100%'");?>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<?php echo form_dropdown('data[dyn_menu][parent_id]',$option['parent'], $dyn_menu['parent_id'],"id='parent_id' required='required' class='form-control select2 filter'   tab-index=1 style='width:100%'");?>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<?php echo form_dropdown('data[dyn_menu][link_type]',$link_type, $dyn_menu['link_type'],"id='link_type_id' required='required' class='form-control select2 filter'   tab-index=1 style='width:100%'");?>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<?php echo form_input($input['module']); ?>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<?php echo form_dropdown('data[dyn_menu][icon_type]',$icon_type, $dyn_menu['icon_type'],"id='icon_type_id' required='required' class='form-control select2 filter'   tab-index=1 style='width:100%'");?>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<input type="file" name="icon_image" class="form-control" id="image_icon" >
													<?php echo form_hidden($input['icon_image_1']); ?>
													<?php 
													if($values_posted['dyn_menu']['icon_type']=="Image"){
														?>

													<img src="<?php echo base_url().'assets/uploads/icons/'.$iconImage; ?>" height="80px" width="80px">
														<?php
													}
													 ?>
												</br>
