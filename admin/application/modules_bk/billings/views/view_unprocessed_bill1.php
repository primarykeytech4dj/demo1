  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <!-- /.box-header -->
        <?php echo form_open('billings/process_bill', ['class'=>'form-horizontal', 'id'=>'process_bill']); ?>
        <div class="box-body" style="overflow-x: scroll;">
          ...
          <input type="hidden" name="data[area_id]" value="<?php echo implode(',', $area_id); ?>" placeholder="">
                ...
                $siteWiseTotal = 0;
                  ...
                  <tr>
                    ...
                    foreach ($products as $productKey => $product) {
                      ...
                      <td><?php echo $bill['service'][$product['id']]['no_of_days']; ?></td>
                      <td><?php echo $bill['service'][$product['id']]['no_of_labour']; ?></td>
                      <td><?php echo $bill['service'][$product['id']]['night_shift_labour_count']; ?></td>
                      <td><?php echo $bill['service'][$product['id']]['no_of_shift']; ?></td>
