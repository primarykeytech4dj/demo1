        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="inputEmp_code" class="col-sm-2 control-label">Client Code</label>
                  <div class="col-sm-10">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="inputJoining_date" class="col-sm-2 control-label">System Entry Date</label>
                  <div class="col-sm-10">
