			...
			<table class="table" id="target">
				...
				if(count($product_attributes)>0){
					...
					<tr id="<?php echo $key; ?>" data-id="<?=$id?>">
						...
						<td>
							<input type="text" name="product_attributes[<?=$key?>][increased_percentage]" id="increased_percentage_<?=$key?>" value="<?=$value['increased_percentage']?>" class="increased_price form-control required" data-id="<?=$id?>">
						</td>
						<td>
					...
					<tr id="0">
						...
						<td>
							<input type="text" name="product_attributes[0][increased_percentage]" id="increased_percentage_0" class="increased_price form-control required" data-id="<?=$id?>">
						</td>
						<td>
