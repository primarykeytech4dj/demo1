...
$input['profile_img2'] = array(
								'data[customers][profile_img2]' => $values_posted['customers']['profile_img'],
...
if(isset($values_posted)) 
	foreach ($values_posted as $post_name => $post_value) {
		foreach ($post_value as $fieldkey => $fieldvalue) {
		    //echo $fieldvalue."<br>";
			if(isset($input[$fieldkey]['type']) && $input[$fieldkey]['type']=='checkbox' && $fieldvalue==true){
	...
	<div class="col-md-12">
		...
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
				...
				<?php if($values_posted['customers']['has_multiple_sites']){
					?>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<?php 
											//print_r($option);
											echo form_dropdown('data[customers][blood_group]', $option['blood_group'], $values_posted['customers']['blood_group'], "id= 'blood_group', required='required', class='form-control select2', style=width:100%"); ?>
