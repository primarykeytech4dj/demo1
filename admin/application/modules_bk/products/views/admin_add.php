								...
								<div class="box-body">
									...
									<div class="col-md-4">
										<div class="form-group">
        									...
        									<?php 
        									if($_SESSION['application']['product_has_multiple_categories']){
        									    echo form_dropdown('data[product_product_categories][product_category_id][]', $option['category'], isset($values_posted)?$values_posted['products']['product_category_id']:'',"id='category' required='required' class='form-control select2' multiple='multiple' style='width:100%'");
