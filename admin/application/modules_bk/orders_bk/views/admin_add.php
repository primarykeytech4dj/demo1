										...
										<table class="table details">
											...
											<tbody>
												<tr id="0">
													...
													<td ><?php echo form_dropdown("order_details[0][product_id]",$option['product'],'',["id" =>'product_id_0', 'required'=>'required', 'class'=>'form-control select2 filter required', 'data-link' => 'products/productwise_attributes', "data-target" => 'productattributeid_0', "style" => 'width:100% !important']);?></td>
													<td ><?php echo form_dropdown("order_details[0][product_attribute_id]", ['select Attributes'],'',["id" =>'productattributeid_0', 'required'=>'required', 'class'=>'form-control select2 attribute', "style" => 'width:100% !important']);?></td>
													<!--td>
													...
													<td>
														<input type="text" name="order_details[0][tax]" class="form-control calculate nochange" id="tax_0" value="0.00">
