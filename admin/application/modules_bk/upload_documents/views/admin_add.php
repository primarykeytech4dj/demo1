				...
				foreach ($userDocuments as $userDocumentKey => $userDocumentValue) { ?>
					<tr id="<?php echo $userDocumentKey; ?>">
						...
						<td>
							...
							<select name="user_documents[<?php echo $userDocumentKey;?>][document_id]" id="document_id_<?php echo $userDocumentKey;?>" class="form-control select2 nochange" style="width:100%">
					...
					<tr id="0">
						...
						<td>
							<?php //print_r($documents); ?>
							<select name="user_documents[0][document_id]" id="document_id_0" class="form-control select2 nochange" style="width:100%">
								<option value="">Select Document Type</option>
								<?php 
								foreach ($documents as $documentKey => $documentValue) {
									?>
