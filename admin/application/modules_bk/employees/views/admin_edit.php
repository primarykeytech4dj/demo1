...
$input['allow_login'] = array(
						...
						"id" => "allow_login",
						"type" => "checkbox",
						"checked" => (TRUE == $values_posted['employees']['allow_login'])?"checked":'',
						"value" => true,
					);
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><?php echo anchor(custom_constants::admin_employees_listing_url, 'Employees', ['title'=>'Employees']) ?></li>
		<li class="active">Edit Employee: <b><?php echo $values_posted['employees']['emp_code']; ?></b></li>
	</ol>
</section>
<!--Main content -->
										...
										<div class="col-md-6">
											...
											<label for="profile_img" class="col-sm-2 control-label">Profile Picture</label>
												<div class="col-sm-10">
													...
													<img src="<?php echo !empty($values_posted['employees']['profile_img'])?content_url().'uploads/profile_images/'.$values_posted['employees']['profile_img']:content_url().'uploads/profile_images/defaultm.jpg'; ?>" height="80px" width="80px">
