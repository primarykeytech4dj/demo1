...
*/ 
	...
	function admin_edit_user($id){
		...
		$userRoles = $this->pktdblib->custom_query('Select * from user_roles where login_id='.$id.' and account_type like "employees"');
	...
	function persistSession(){
	    ...
	    check_user_login(FALSE);
	    echo json_encode(['msg'=>'reached in persist session', 'status'=>'success']);
	}
}
