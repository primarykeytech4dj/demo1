...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo base_url(); ?>employees">Companies</a></li>
  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <div class="box box-primary">
        <?php echo anchor(custom_constants::edit_company_url.'/'.$user['id'], '<i class="fa fa-edit pull-right"></i>'); ?>
        <div class="box-body box-profile">
          <?php //print_r($user); ?>
          <?php echo img(['src'=>content_url().'uploads/profile_images/'.$user['logo'], 'class'=>'profile-user-img img-responsive img-circle', 'alt'=>$user['first_name']]); ?>

          <h3 class="profile-username text-center"><?php echo $user['first_name']." ".$user['middle_name']." ".$user['surname']; ?></h3>
          <h5 class="text-muted pull-left"><?php echo "Short Code: ".$user['short_code']; ?><br><?php echo "Slug: ".$user['slug']; ?></h5>
          <h5 class="text-muted pull-left"><?php echo "Pan No: ".$user['pan_no']; ?><br><?php echo "GST: ".$user['gst_no']; ?></h5>
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <strong><i class="fa fa-calendar-check-o margin-r-5"></i> Company Name</strong>
