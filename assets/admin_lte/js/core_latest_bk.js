$(function() {
  ...
  //Initialize Select2 Elements
    ...
    tinymce.init({ 
      selector:'.textarea', 
      plugins: 'fullpage image textcolor colorpicker paste table media', 
      automatic_uploads: true,
      //theme: "inlite",
      //inline: true,
     // menubar: 'edit file',
      toolbar: 'bullist numlist bold italic underline strikethrough forecolor backcolor alignleft aligncenter alignright alignjustify alignnone styleselect formatselect fontselect fontsizeselect table media',
...
// Add more for colleges aluminis
    ...
    //$('.filter').on('change click',function(event){
  ...
  $(document).on('change', '.viewInput', function(){
    ...
    var val = $('#'+id).val();
    //console.log($('#'+id).val());
    var targetInput = $('#'+id).attr('data-target');
    if(val==0){
